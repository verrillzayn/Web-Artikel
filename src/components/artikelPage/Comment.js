...
const Kommentar = () => {
  return (
    <section className="bg-white dark:bg-gray-900 py-1 lg:py-1">
      <div className="max-w-2xl mx-auto px-2">
        ...
        <form className="mb-6">
          <div className="py-2 px-4 mb-4 bg-white rounded-lg rounded-t-lg border border-gray-400 dark:bg-gray-800 dark:border-gray-700 focus-within:border-primaryTheme focus-within:border-2">
